...
CODE THAT MAKES THIS TYPE OF ANIMATION POSSIBLE, I STRONGLY ADVISE LOOKING AT THE PROTOTYPE FILE, AS IT HAS A MUCH BETTER
CONSTRUCTION BASE.  THAT SAID, THIS IS ADVANCED BLENDER PYTHON CODING, NOT FOR THE FAINT OF HEART.  BECAUSE I HAVE SOLVED
MOST OF THE MAJOR DIFFICULTIES, I AM POSTING A PROTOTYPE, BUT EXPECT THAT IT WILL STILL BE A CONSIDERABLE AMOUNT OF TIME
BEFORE FULL-VERSION RELEASE.  THIS PROTOTYPE IS NOT YET OF ANY USE TO ANIMATORS, FOR THAT SEE BELOW, THE FILES OF BLENDER
VERSIONS BEFORE 2.8.
