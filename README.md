...
INTO THE TEXT EDITOR, MOST BUTTONS NOW WORK for the BIPED.  It has the buttton now for the build of the skeleton 
for the Centaur, but no programming behind it yet. I plan on adding all the skeletons for the rest of the characters
first before doing the programming, it will help show where things are headed.
