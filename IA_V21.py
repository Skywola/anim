    ...
    for obj in bpy.context.scene.objects:
        if(obj.name.startswith("rg")):
            ...
            if(char.startswith("bird")):
                ...
                if(not hasattr(bpy.types.WindowManager, "neckFB")):
                ...
                if(not hasattr(bpy.types.WindowManager, "wingsOuterFeathers")):
            ...
            if(char.startswith("centaur")):
                ...
                if(not hasattr(bpy.types.WindowManager, "rearFemurJ1RP")):
                ...
                if(not hasattr(bpy.types.WindowManager, "rearFemurJ1RR")):
                ...
                if(not hasattr(bpy.types.WindowManager, "rearTibiaJ1RP")):
                ...
                if(not hasattr(bpy.types.WindowManager, "rearTibiaJ1RR")):
                ...
                if(not hasattr(bpy.types.WindowManager, "rearAnkleRP")):
                ...
                if(not hasattr(bpy.types.WindowManager, "rearAnkleRR")):
            ...
            if(char.startswith("adWings")):
                ...
                if(not hasattr(bpy.types.WindowManager, "adWingsOuterFeathers")):
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# END COMMON FUNCTION - addCharactersProperties
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
